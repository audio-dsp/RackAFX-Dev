...
void CSampleOscillator::update()
{
	...
	double dUnityFrequency = m_bSingleCycleSample ? (m_dSampleRate/(pSample->m_uSampleCount/pSample->m_uNumChannels)) : midiFreqTable[pSample->m_uMIDINote];
	...
	// alternate calculation, but modulation won't work
	//m_dInc = m_dOscFo/dUnityFrequency;
}
