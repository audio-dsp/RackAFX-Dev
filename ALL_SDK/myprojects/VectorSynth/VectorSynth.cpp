...
*/
CVectorSynth::~CVectorSynth(void)
{
...
{
	// --- load the multisamples
	loadSamples();

	return true;
}

bool CVectorSynth::loadSamples()
{
	...
	char* pPath2 = addStrings(getMyDLLDirectory(),"\\MultiSamples\\Divider");
	char* pPath3 = addStrings(getMyDLLDirectory(),"\\MultiSamples\\FuzzVibe");

	// --- to speed up sample loading, init the first voice here
	//     init(...false, false) = NOT single-sample, NOT pitchless sample
	if(!m_pVoiceArray[0]->initOscWithFolderPath(0, pPath0, false, false)) return false;
	if(!m_pVoiceArray[0]->initOscWithFolderPath(1, pPath1, false, false)) return false;
	if(!m_pVoiceArray[0]->initOscWithFolderPath(2, pPath2, false, false)) return false;
	if(!m_pVoiceArray[0]->initOscWithFolderPath(3, pPath3, false, false)) return false;
...
*/
bool __stdcall CVectorSynth::prepareForPlay()
{
	for(int i=0; i<MAX_VOICES; i++)
	{
		if(m_pVoiceArray[i])
...
*/
bool __stdcall CVectorSynth::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
//
bool __stdcall CVectorSynth::userInterfaceChange(int nControlIndex)
{
	update();
...
*/
bool __stdcall CVectorSynth::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// --- update globals
...
*/
bool __stdcall CVectorSynth::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CVectorSynth::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
void CVectorSynth::incrementVoiceTimestamps()
{
	for(int i=0; i<MAX_VOICES; i++)
	{
		if(m_pVoiceArray[i])
...
// --- get oldest note
CVectorSynthVoice* CVectorSynth::getOldestVoice()
{
	int nTimeStamp = -1;
...
CVectorSynthVoice* CVectorSynth::getOldestVoiceWithNote(UINT uMIDINote)
{
	int nTimeStamp = -1;
	CVectorSynthVoice* pFoundVoice = NULL;
	for(int i=0; i<MAX_VOICES; i++)
...
bool __stdcall CVectorSynth::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	// test channel/ignore
...
bool __stdcall CVectorSynth::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	// test channel/ignore
	if(m_uMidiRxChannel != MIDI_CH_ALL && uChannel != m_uMidiRxChannel)
	{
...
// uModValue = 0->127
bool __stdcall CVectorSynth::midiModWheel(UINT uChannel, UINT uModValue)
{
	// test channel/ignore
	if(m_uMidiRxChannel != MIDI_CH_ALL && uChannel != m_uMidiRxChannel)
		return false;
...
bool __stdcall CVectorSynth::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	// test channel/ignore
	if(m_uMidiRxChannel != MIDI_CH_ALL && uChannel != m_uMidiRxChannel)
		return false;
...
*/
bool __stdcall CVectorSynth::midiClock()
{
...
bool __stdcall CVectorSynth::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CVectorSynth::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui0.dPresetData[0] = 0.000000;ui0.dPresetData[1] = 0.000000;ui0.dPresetData[2] = 1.000000;ui0.dPresetData[3] = 0.000000;ui0.dPresetData[4] = 0.000000;ui0.dPresetData[5] = 0.000000;ui0.dPresetData[6] = 0.000000;ui0.dPresetData[7] = 0.000000;ui0.dPresetData[8] = 0.000000;ui0.dPresetData[9] = 0.000000;ui0.dPresetData[10] = 0.000000;ui0.dPresetData[11] = 0.000000;ui0.dPresetData[12] = 0.000000;ui0.dPresetData[13] = 0.000000;ui0.dPresetData[14] = 0.000000;ui0.dPresetData[15] = 0.000000;
	...
	ui1.dPresetData[0] = 0.000000;ui1.dPresetData[1] = 0.000000;ui1.dPresetData[2] = 6.250000;ui1.dPresetData[3] = 0.000000;ui1.dPresetData[4] = 0.000000;ui1.dPresetData[5] = 0.000000;ui1.dPresetData[6] = 0.000000;ui1.dPresetData[7] = 0.000000;ui1.dPresetData[8] = 0.000000;ui1.dPresetData[9] = 0.000000;ui1.dPresetData[10] = 0.000000;ui1.dPresetData[11] = 0.000000;ui1.dPresetData[12] = 0.000000;ui1.dPresetData[13] = 0.000000;ui1.dPresetData[14] = 0.000000;ui1.dPresetData[15] = 0.000000;
	...
	ui2.dPresetData[0] = 10000.000000;ui2.dPresetData[1] = 382.599457;ui2.dPresetData[2] = 2106.514648;ui2.dPresetData[3] = 0.000000;ui2.dPresetData[4] = 0.000000;ui2.dPresetData[5] = 0.000000;ui2.dPresetData[6] = 0.000000;ui2.dPresetData[7] = 0.000000;ui2.dPresetData[8] = 0.000000;ui2.dPresetData[9] = 0.000000;ui2.dPresetData[10] = 0.000000;ui2.dPresetData[11] = 0.000000;ui2.dPresetData[12] = 0.000000;ui2.dPresetData[13] = 0.000000;ui2.dPresetData[14] = 0.000000;ui2.dPresetData[15] = 0.000000;
	...
	ui3.dPresetData[0] = 0.500000;ui3.dPresetData[1] = 0.500000;ui3.dPresetData[2] = 0.500000;ui3.dPresetData[3] = 0.000000;ui3.dPresetData[4] = 0.000000;ui3.dPresetData[5] = 0.000000;ui3.dPresetData[6] = 0.000000;ui3.dPresetData[7] = 0.000000;ui3.dPresetData[8] = 0.000000;ui3.dPresetData[9] = 0.000000;ui3.dPresetData[10] = 0.000000;ui3.dPresetData[11] = 0.000000;ui3.dPresetData[12] = 0.000000;ui3.dPresetData[13] = 0.000000;ui3.dPresetData[14] = 0.000000;ui3.dPresetData[15] = 0.000000;
	...
	ui4.dPresetData[0] = 100.000000;ui4.dPresetData[1] = 507.812500;ui4.dPresetData[2] = 507.812500;ui4.dPresetData[3] = 0.000000;ui4.dPresetData[4] = 0.000000;ui4.dPresetData[5] = 0.000000;ui4.dPresetData[6] = 0.000000;ui4.dPresetData[7] = 0.000000;ui4.dPresetData[8] = 0.000000;ui4.dPresetData[9] = 0.000000;ui4.dPresetData[10] = 0.000000;ui4.dPresetData[11] = 0.000000;ui4.dPresetData[12] = 0.000000;ui4.dPresetData[13] = 0.000000;ui4.dPresetData[14] = 0.000000;ui4.dPresetData[15] = 0.000000;
	...
	ui5.dPresetData[0] = 0.000000;ui5.dPresetData[1] = 0.000000;ui5.dPresetData[2] = 0.945313;ui5.dPresetData[3] = 0.000000;ui5.dPresetData[4] = 0.000000;ui5.dPresetData[5] = 0.000000;ui5.dPresetData[6] = 0.000000;ui5.dPresetData[7] = 0.000000;ui5.dPresetData[8] = 0.000000;ui5.dPresetData[9] = 0.000000;ui5.dPresetData[10] = 0.000000;ui5.dPresetData[11] = 0.000000;ui5.dPresetData[12] = 0.000000;ui5.dPresetData[13] = 0.000000;ui5.dPresetData[14] = 0.000000;ui5.dPresetData[15] = 0.000000;
	...
	ui8.dPresetData[0] = 0.000000;ui8.dPresetData[1] = 0.000000;ui8.dPresetData[2] = 1640.625000;ui8.dPresetData[3] = 0.000000;ui8.dPresetData[4] = 0.000000;ui8.dPresetData[5] = 0.000000;ui8.dPresetData[6] = 0.000000;ui8.dPresetData[7] = 0.000000;ui8.dPresetData[8] = 0.000000;ui8.dPresetData[9] = 0.000000;ui8.dPresetData[10] = 0.000000;ui8.dPresetData[11] = 0.000000;ui8.dPresetData[12] = 0.000000;ui8.dPresetData[13] = 0.000000;ui8.dPresetData[14] = 0.000000;ui8.dPresetData[15] = 0.000000;
	...
	ui9.dPresetData[0] = 1.000000;ui9.dPresetData[1] = 9.999373;ui9.dPresetData[2] = 6.320633;ui9.dPresetData[3] = 0.000000;ui9.dPresetData[4] = 0.000000;ui9.dPresetData[5] = 0.000000;ui9.dPresetData[6] = 0.000000;ui9.dPresetData[7] = 0.000000;ui9.dPresetData[8] = 0.000000;ui9.dPresetData[9] = 0.000000;ui9.dPresetData[10] = 0.000000;ui9.dPresetData[11] = 0.000000;ui9.dPresetData[12] = 0.000000;ui9.dPresetData[13] = 0.000000;ui9.dPresetData[14] = 0.000000;ui9.dPresetData[15] = 0.000000;
	...
	ui11.dPresetData[0] = 1000.000000;ui11.dPresetData[1] = 2968.750000;ui11.dPresetData[2] = 2968.750000;ui11.dPresetData[3] = 0.000000;ui11.dPresetData[4] = 0.000000;ui11.dPresetData[5] = 0.000000;ui11.dPresetData[6] = 0.000000;ui11.dPresetData[7] = 0.000000;ui11.dPresetData[8] = 0.000000;ui11.dPresetData[9] = 0.000000;ui11.dPresetData[10] = 0.000000;ui11.dPresetData[11] = 0.000000;ui11.dPresetData[12] = 0.000000;ui11.dPresetData[13] = 0.000000;ui11.dPresetData[14] = 0.000000;ui11.dPresetData[15] = 0.000000;
	...
	ui12.dPresetData[0] = 0.000000;ui12.dPresetData[1] = 0.000000;ui12.dPresetData[2] = 0.863281;ui12.dPresetData[3] = 0.000000;ui12.dPresetData[4] = 0.000000;ui12.dPresetData[5] = 0.000000;ui12.dPresetData[6] = 0.000000;ui12.dPresetData[7] = 0.000000;ui12.dPresetData[8] = 0.000000;ui12.dPresetData[9] = 0.000000;ui12.dPresetData[10] = 0.000000;ui12.dPresetData[11] = 0.000000;ui12.dPresetData[12] = 0.000000;ui12.dPresetData[13] = 0.000000;ui12.dPresetData[14] = 0.000000;ui12.dPresetData[15] = 0.000000;
	...
	ui14.cEnumeratedList = "once,loop,sustain,bckfrth";
	...
	ui16.dPresetData[0] = 0.000000;ui16.dPresetData[1] = 0.890625;ui16.dPresetData[2] = 0.890625;ui16.dPresetData[3] = 0.000000;ui16.dPresetData[4] = 0.000000;ui16.dPresetData[5] = 0.000000;ui16.dPresetData[6] = 0.000000;ui16.dPresetData[7] = 0.000000;ui16.dPresetData[8] = 0.000000;ui16.dPresetData[9] = 0.000000;ui16.dPresetData[10] = 0.000000;ui16.dPresetData[11] = 0.000000;ui16.dPresetData[12] = 0.000000;ui16.dPresetData[13] = 0.000000;ui16.dPresetData[14] = 0.000000;ui16.dPresetData[15] = 0.000000;
	...
	ui18.dPresetData[0] = 0.500000;ui18.dPresetData[1] = 0.898438;ui18.dPresetData[2] = 0.898438;ui18.dPresetData[3] = 0.000000;ui18.dPresetData[4] = 0.000000;ui18.dPresetData[5] = 0.000000;ui18.dPresetData[6] = 0.000000;ui18.dPresetData[7] = 0.000000;ui18.dPresetData[8] = 0.000000;ui18.dPresetData[9] = 0.000000;ui18.dPresetData[10] = 0.000000;ui18.dPresetData[11] = 0.000000;ui18.dPresetData[12] = 0.000000;ui18.dPresetData[13] = 0.000000;ui18.dPresetData[14] = 0.000000;ui18.dPresetData[15] = 0.000000;
	...
	ui22.dPresetData[0] = 0.000000;ui22.dPresetData[1] = 0.000000;ui22.dPresetData[2] = 1.000000;ui22.dPresetData[3] = 0.000000;ui22.dPresetData[4] = 0.000000;ui22.dPresetData[5] = 0.000000;ui22.dPresetData[6] = 0.000000;ui22.dPresetData[7] = 0.000000;ui22.dPresetData[8] = 0.000000;ui22.dPresetData[9] = 0.000000;ui22.dPresetData[10] = 0.000000;ui22.dPresetData[11] = 0.000000;ui22.dPresetData[12] = 0.000000;ui22.dPresetData[13] = 0.000000;ui22.dPresetData[14] = 0.000000;ui22.dPresetData[15] = 0.000000;
	...
	ui26.dPresetData[0] = 0.000000;ui26.dPresetData[1] = 24.000000;ui26.dPresetData[2] = 24.000000;ui26.dPresetData[3] = 0.000000;ui26.dPresetData[4] = 0.000000;ui26.dPresetData[5] = 0.000000;ui26.dPresetData[6] = 0.000000;ui26.dPresetData[7] = 0.000000;ui26.dPresetData[8] = 0.000000;ui26.dPresetData[9] = 0.000000;ui26.dPresetData[10] = 0.000000;ui26.dPresetData[11] = 0.000000;ui26.dPresetData[12] = 0.000000;ui26.dPresetData[13] = 0.000000;ui26.dPresetData[14] = 0.000000;ui26.dPresetData[15] = 0.000000;
	...
	ui28.dPresetData[0] = 1.000000;ui28.dPresetData[1] = 1.000000;ui28.dPresetData[2] = 1.000000;ui28.dPresetData[3] = 0.000000;ui28.dPresetData[4] = 0.000000;ui28.dPresetData[5] = 0.000000;ui28.dPresetData[6] = 0.000000;ui28.dPresetData[7] = 0.000000;ui28.dPresetData[8] = 0.000000;ui28.dPresetData[9] = 0.000000;ui28.dPresetData[10] = 0.000000;ui28.dPresetData[11] = 0.000000;ui28.dPresetData[12] = 0.000000;ui28.dPresetData[13] = 0.000000;ui28.dPresetData[14] = 0.000000;ui28.dPresetData[15] = 0.000000;
	...
	ui31.dPresetData[0] = 1.000000;ui31.dPresetData[1] = 1.000000;ui31.dPresetData[2] = 1.000000;ui31.dPresetData[3] = 0.000000;ui31.dPresetData[4] = 0.000000;ui31.dPresetData[5] = 0.000000;ui31.dPresetData[6] = 0.000000;ui31.dPresetData[7] = 0.000000;ui31.dPresetData[8] = 0.000000;ui31.dPresetData[9] = 0.000000;ui31.dPresetData[10] = 0.000000;ui31.dPresetData[11] = 0.000000;ui31.dPresetData[12] = 0.000000;ui31.dPresetData[13] = 0.000000;ui31.dPresetData[14] = 0.000000;ui31.dPresetData[15] = 0.000000;
	...
	m_pVectorJSProgram[JS_PROG_INDEX(0,0)] = 0.2400;
	m_pVectorJSProgram[JS_PROG_INDEX(0,1)] = 0.2100;
	m_pVectorJSProgram[JS_PROG_INDEX(0,2)] = 0.2500;
	m_pVectorJSProgram[JS_PROG_INDEX(0,3)] = 0.2900;
	m_pVectorJSProgram[JS_PROG_INDEX(0,4)] = 1000.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(0,5)] = 0.5000;
	m_pVectorJSProgram[JS_PROG_INDEX(0,6)] = 0.4600;
	m_pVectorJSProgram[JS_PROG_INDEX(1,0)] = 0.9900;
	m_pVectorJSProgram[JS_PROG_INDEX(1,1)] = 0.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(1,2)] = 0.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(1,3)] = 0.0200;
	m_pVectorJSProgram[JS_PROG_INDEX(1,4)] = 2000.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(1,5)] = 0.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(1,6)] = 0.4900;
	m_pVectorJSProgram[JS_PROG_INDEX(2,0)] = 0.0100;
	m_pVectorJSProgram[JS_PROG_INDEX(2,1)] = 0.9900;
	m_pVectorJSProgram[JS_PROG_INDEX(2,2)] = 0.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(2,3)] = 0.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(2,4)] = 2000.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(2,5)] = 0.4900;
	m_pVectorJSProgram[JS_PROG_INDEX(2,6)] = 1.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(3,0)] = 0.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(3,1)] = 0.0200;
	m_pVectorJSProgram[JS_PROG_INDEX(3,2)] = 0.9800;
	m_pVectorJSProgram[JS_PROG_INDEX(3,3)] = 0.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(3,4)] = 2000.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(3,5)] = 0.9900;
	m_pVectorJSProgram[JS_PROG_INDEX(3,6)] = 0.5100;
	...
	m_pVectorJSProgram[JS_PROG_INDEX(4,3)] = 1.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(4,4)] = 2000.0000;
	m_pVectorJSProgram[JS_PROG_INDEX(4,5)] = 0.5000;
