...
CDigiSynth::CDigiSynth()
{
	...
	{
		// --- create voice
		m_pVoiceArray[i] = new CDigiSynthVoice;
...
{
	// --- just load the sample sets
	return loadSamples();
}

// --- to load up the samples in new voices
bool CDigiSynth::loadSamples()
{
...
*/
bool __stdcall CDigiSynth::prepareForPlay()
{
	// Add your code here:
	for(int i=0; i<MAX_VOICES; i++)
	{
...
*/
bool __stdcall CDigiSynth::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	// Do LEFT (MONO) Channel; there is always at least one input/one output
	double dLeftAccum = 0.0;
	double dRightAccum = 0.0;

	// --- samples typically are down
	//     12 dB for Headroom, mix = 1.0
	float fMix = 1.0;
	double dLeft = 0.0;
	double dRight = 0.0;
...
//
bool __stdcall CDigiSynth::userInterfaceChange(int nControlIndex)
{
	update();
...
*/
bool __stdcall CDigiSynth::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CDigiSynth::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CDigiSynth::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
void CDigiSynth::incrementVoiceTimestamps()
{
	for(int i=0; i<MAX_VOICES; i++)
	{
		if(m_pVoiceArray[i])
...
// --- get oldest note
CDigiSynthVoice* CDigiSynth::getOldestVoice()
{
	int nTimeStamp = -1;
	CDigiSynthVoice* pFoundVoice = NULL;
	for(int i=0; i<MAX_VOICES; i++)
	{
		if(m_pVoiceArray[i])
		{
...
CDigiSynthVoice* CDigiSynth::getOldestVoiceWithNote(UINT uMIDINote)
{
	int nTimeStamp = -1;
	CDigiSynthVoice* pFoundVoice = NULL;
	for(int i=0; i<MAX_VOICES; i++)
...
bool __stdcall CDigiSynth::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	// test channel/ignore
	...
	{
		// steal oldest note
		CDigiSynthVoice* pVoice = getOldestVoice();
		if(pVoice)
		{
			// do this first
			incrementVoiceTimestamps();
...
bool __stdcall CDigiSynth::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	// test channel/ignore
	if(m_uMidiRxChannel != MIDI_CH_ALL && uChannel != m_uMidiRxChannel)
	{
	...
	for(int i=0; i<MAX_VOICES; i++)
	{
		CDigiSynthVoice* pVoice = getOldestVoiceWithNote(uMIDINote);
		if(pVoice)
		{
...
// uModValue = 0->127
bool __stdcall CDigiSynth::midiModWheel(UINT uChannel, UINT uModValue)
{
	// test channel/ignore
	if(m_uMidiRxChannel != MIDI_CH_ALL && uChannel != m_uMidiRxChannel)
		return false;
...
bool __stdcall CDigiSynth::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	// test channel/ignore
	if(m_uMidiRxChannel != MIDI_CH_ALL && uChannel != m_uMidiRxChannel)
		return false;
...
*/
bool __stdcall CDigiSynth::midiClock()
{
...
bool __stdcall CDigiSynth::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CDigiSynth::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui0.cEnumeratedList = "Osc1,Osc2,split,layer";
	ui0.dPresetData[0] = 0.000000;ui0.dPresetData[1] = 0.000000;ui0.dPresetData[2] = 2.000000;ui0.dPresetData[3] = 0.000000;ui0.dPresetData[4] = 0.000000;ui0.dPresetData[5] = 0.000000;ui0.dPresetData[6] = 0.000000;ui0.dPresetData[7] = 0.000000;ui0.dPresetData[8] = 0.000000;ui0.dPresetData[9] = 0.000000;ui0.dPresetData[10] = 0.000000;ui0.dPresetData[11] = 0.000000;ui0.dPresetData[12] = 0.000000;ui0.dPresetData[13] = 0.000000;ui0.dPresetData[14] = 0.000000;ui0.dPresetData[15] = 0.000000;
	...
	ui1.dPresetData[0] = 0.000000;ui1.dPresetData[1] = 0.000000;ui1.dPresetData[2] = 3.906250;ui1.dPresetData[3] = 0.000000;ui1.dPresetData[4] = 0.000000;ui1.dPresetData[5] = 0.000000;ui1.dPresetData[6] = 0.000000;ui1.dPresetData[7] = 0.000000;ui1.dPresetData[8] = 0.000000;ui1.dPresetData[9] = 0.000000;ui1.dPresetData[10] = 0.000000;ui1.dPresetData[11] = 0.000000;ui1.dPresetData[12] = 0.000000;ui1.dPresetData[13] = 0.000000;ui1.dPresetData[14] = 0.000000;ui1.dPresetData[15] = 0.000000;
	...
	ui2.dPresetData[0] = 10000.000000;ui2.dPresetData[1] = 1225.700684;ui2.dPresetData[2] = 1225.700684;ui2.dPresetData[3] = 0.000000;ui2.dPresetData[4] = 0.000000;ui2.dPresetData[5] = 0.000000;ui2.dPresetData[6] = 0.000000;ui2.dPresetData[7] = 0.000000;ui2.dPresetData[8] = 0.000000;ui2.dPresetData[9] = 0.000000;ui2.dPresetData[10] = 0.000000;ui2.dPresetData[11] = 0.000000;ui2.dPresetData[12] = 0.000000;ui2.dPresetData[13] = 0.000000;ui2.dPresetData[14] = 0.000000;ui2.dPresetData[15] = 0.000000;
	...
	ui3.dPresetData[0] = 0.500000;ui3.dPresetData[1] = 0.500000;ui3.dPresetData[2] = 2.320078;ui3.dPresetData[3] = 0.000000;ui3.dPresetData[4] = 0.000000;ui3.dPresetData[5] = 0.000000;ui3.dPresetData[6] = 0.000000;ui3.dPresetData[7] = 0.000000;ui3.dPresetData[8] = 0.000000;ui3.dPresetData[9] = 0.000000;ui3.dPresetData[10] = 0.000000;ui3.dPresetData[11] = 0.000000;ui3.dPresetData[12] = 0.000000;ui3.dPresetData[13] = 0.000000;ui3.dPresetData[14] = 0.000000;ui3.dPresetData[15] = 0.000000;
	...
	ui4.dPresetData[0] = 100.000000;ui4.dPresetData[1] = 100.000000;ui4.dPresetData[2] = 0.000000;ui4.dPresetData[3] = 0.000000;ui4.dPresetData[4] = 0.000000;ui4.dPresetData[5] = 0.000000;ui4.dPresetData[6] = 0.000000;ui4.dPresetData[7] = 0.000000;ui4.dPresetData[8] = 0.000000;ui4.dPresetData[9] = 0.000000;ui4.dPresetData[10] = 0.000000;ui4.dPresetData[11] = 0.000000;ui4.dPresetData[12] = 0.000000;ui4.dPresetData[13] = 0.000000;ui4.dPresetData[14] = 0.000000;ui4.dPresetData[15] = 0.000000;
	...
	ui5.fUserDisplayDataLoLimit = -96.000000;
	ui5.fUserDisplayDataHiLimit = 24.000000;
	...
	ui5.m_pUserCookedDoubleData = &m_dOsc1Amplitude_dB;
	ui5.m_pUserCookedUINTData = NULL;
	ui5.cControlUnits = "dB                                                              ";
	ui5.cVariableName = "m_dOsc1Amplitude_dB";
	...
	ui7.m_pUserCookedDoubleData = &m_dPortamentoTime_mSec;
	ui7.m_pUserCookedUINTData = NULL;
	ui7.cControlUnits = "mS                                                              ";
	ui7.cVariableName = "m_dPortamentoTime_mSec";
	...
	ui8.fUserDisplayDataHiLimit = 10.000000;
	ui8.uUserDataType = doubleData;
	ui8.fInitUserIntValue = 0;
	ui8.fInitUserFloatValue = 0;
	ui8.fInitUserDoubleValue = 1.000000;
	ui8.fInitUserUINTValue = 0;
	ui8.m_pUserCookedIntData = NULL;
	ui8.m_pUserCookedFloatData = NULL;
	ui8.m_pUserCookedDoubleData = &m_dQControl;
	ui8.m_pUserCookedUINTData = NULL;
	ui8.cControlUnits = "                                                                ";
	ui8.cVariableName = "m_dQControl";
	ui8.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui8.dPresetData[0] = 1.000000;ui8.dPresetData[1] = 4.782553;ui8.dPresetData[2] = 4.782553;ui8.dPresetData[3] = 0.000000;ui8.dPresetData[4] = 0.000000;ui8.dPresetData[5] = 0.000000;ui8.dPresetData[6] = 0.000000;ui8.dPresetData[7] = 0.000000;ui8.dPresetData[8] = 0.000000;ui8.dPresetData[9] = 0.000000;ui8.dPresetData[10] = 0.000000;ui8.dPresetData[11] = 0.000000;ui8.dPresetData[12] = 0.000000;ui8.dPresetData[13] = 0.000000;ui8.dPresetData[14] = 0.000000;ui8.dPresetData[15] = 0.000000;
	ui8.cControlName = "Filter Q";
	...
	ui9.m_pUserCookedDoubleData = &m_dLFO1OscPitchIntensity;
	ui9.m_pUserCookedUINTData = NULL;
	ui9.cControlUnits = "                                                                ";
	ui9.cVariableName = "m_dLFO1OscPitchIntensity";
	...
	ui9.cControlName = "LFO Pitch Int";
	...
	ui10.fUserDisplayDataHiLimit = 10000.000000;
	ui10.uUserDataType = doubleData;
	ui10.fInitUserIntValue = 0;
	ui10.fInitUserFloatValue = 0;
	ui10.fInitUserDoubleValue = 1000.000000;
	ui10.fInitUserUINTValue = 0;
	ui10.m_pUserCookedIntData = NULL;
	ui10.m_pUserCookedFloatData = NULL;
	ui10.m_pUserCookedDoubleData = &m_dDecayReleaseTime_mSec;
	ui10.m_pUserCookedUINTData = NULL;
	ui10.cControlUnits = "mS                                                              ";
	ui10.cVariableName = "m_dDecayReleaseTime_mSec";
	ui10.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui10.dPresetData[0] = 1000.000000;ui10.dPresetData[1] = 1000.000000;ui10.dPresetData[2] = 1000.000000;ui10.dPresetData[3] = 0.000000;ui10.dPresetData[4] = 0.000000;ui10.dPresetData[5] = 0.000000;ui10.dPresetData[6] = 0.000000;ui10.dPresetData[7] = 0.000000;ui10.dPresetData[8] = 0.000000;ui10.dPresetData[9] = 0.000000;ui10.dPresetData[10] = 0.000000;ui10.dPresetData[11] = 0.000000;ui10.dPresetData[12] = 0.000000;ui10.dPresetData[13] = 0.000000;ui10.dPresetData[14] = 0.000000;ui10.dPresetData[15] = 0.000000;
	ui10.cControlName = "Decay/Release";
	...
	ui11.fUserDisplayDataLoLimit = -96.000000;
	ui11.fUserDisplayDataHiLimit = 24.000000;
	...
	ui11.m_pUserCookedDoubleData = &m_dOsc2Amplitude_dB;
	ui11.m_pUserCookedUINTData = NULL;
	ui11.cControlUnits = "dB                                                              ";
	ui11.cVariableName = "m_dOsc2Amplitude_dB";
	...
	ui12.cControlName = "LFO Amplitude";
	...
	ui13.m_pUserCookedDoubleData = &m_dEG1OscIntensity;
	ui13.m_pUserCookedUINTData = NULL;
	ui13.cControlUnits = "                                                                ";
	ui13.cVariableName = "m_dEG1OscIntensity";
	...
	ui14.m_pUserCookedDoubleData = &m_dEG1FilterIntensity;
	ui14.m_pUserCookedUINTData = NULL;
	ui14.cControlUnits = "                                                                ";
	ui14.cVariableName = "m_dEG1FilterIntensity";
	ui14.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui14.dPresetData[0] = 0.000000;ui14.dPresetData[1] = 0.992188;ui14.dPresetData[2] = 0.992188;ui14.dPresetData[3] = 0.000000;ui14.dPresetData[4] = 0.000000;ui14.dPresetData[5] = 0.000000;ui14.dPresetData[6] = 0.000000;ui14.dPresetData[7] = 0.000000;ui14.dPresetData[8] = 0.000000;ui14.dPresetData[9] = 0.000000;ui14.dPresetData[10] = 0.000000;ui14.dPresetData[11] = 0.000000;ui14.dPresetData[12] = 0.000000;ui14.dPresetData[13] = 0.000000;ui14.dPresetData[14] = 0.000000;ui14.dPresetData[15] = 0.000000;
	ui14.cControlName = "Filter  EG Int";
	...
	ui15.m_pUserCookedDoubleData = &m_dLFO1FilterFcIntensity;
	ui15.m_pUserCookedUINTData = NULL;
	ui15.cControlUnits = "                                                                ";
	ui15.cVariableName = "m_dLFO1FilterFcIntensity";
	ui15.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui15.dPresetData[0] = 0.000000;ui15.dPresetData[1] = 0.000000;ui15.dPresetData[2] = 0.023438;ui15.dPresetData[3] = 0.000000;ui15.dPresetData[4] = 0.000000;ui15.dPresetData[5] = 0.000000;ui15.dPresetData[6] = 0.000000;ui15.dPresetData[7] = 0.000000;ui15.dPresetData[8] = 0.000000;ui15.dPresetData[9] = 0.000000;ui15.dPresetData[10] = 0.000000;ui15.dPresetData[11] = 0.000000;ui15.dPresetData[12] = 0.000000;ui15.dPresetData[13] = 0.000000;ui15.dPresetData[14] = 0.000000;ui15.dPresetData[15] = 0.000000;
	ui15.cControlName = "LFO Cutoff Int";
	...
	ui16.fInitUserDoubleValue = 0.710000;
	ui16.fInitUserUINTValue = 0;
	ui16.m_pUserCookedIntData = NULL;
	ui16.m_pUserCookedFloatData = NULL;
	ui16.m_pUserCookedDoubleData = &m_dSustainLevel;
	ui16.m_pUserCookedUINTData = NULL;
	ui16.cControlUnits = "                                                                ";
	ui16.cVariableName = "m_dSustainLevel";
	ui16.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui16.dPresetData[0] = 0.710000;ui16.dPresetData[1] = 0.500000;ui16.dPresetData[2] = 0.917969;ui16.dPresetData[3] = 0.000000;ui16.dPresetData[4] = 0.000000;ui16.dPresetData[5] = 0.000000;ui16.dPresetData[6] = 0.000000;ui16.dPresetData[7] = 0.000000;ui16.dPresetData[8] = 0.000000;ui16.dPresetData[9] = 0.000000;ui16.dPresetData[10] = 0.000000;ui16.dPresetData[11] = 0.000000;ui16.dPresetData[12] = 0.000000;ui16.dPresetData[13] = 0.000000;ui16.dPresetData[14] = 0.000000;ui16.dPresetData[15] = 0.000000;
	ui16.cControlName = "Sustain";
	...
	ui17.m_pUserCookedDoubleData = &m_dLFO1AmpIntensity;
	ui17.m_pUserCookedUINTData = NULL;
	ui17.cControlUnits = "                                                                ";
	ui17.cVariableName = "m_dLFO1AmpIntensity";
	...
	ui18.m_pUserCookedDoubleData = &m_dLFO1PanIntensity;
	ui18.m_pUserCookedUINTData = NULL;
	ui18.cControlUnits = "                                                                ";
	ui18.cVariableName = "m_dLFO1PanIntensity";
	ui18.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui18.dPresetData[0] = 0.000000;ui18.dPresetData[1] = 0.000000;ui18.dPresetData[2] = 1.000000;ui18.dPresetData[3] = 0.000000;ui18.dPresetData[4] = 0.000000;ui18.dPresetData[5] = 0.000000;ui18.dPresetData[6] = 0.000000;ui18.dPresetData[7] = 0.000000;ui18.dPresetData[8] = 0.000000;ui18.dPresetData[9] = 0.000000;ui18.dPresetData[10] = 0.000000;ui18.dPresetData[11] = 0.000000;ui18.dPresetData[12] = 0.000000;ui18.dPresetData[13] = 0.000000;ui18.dPresetData[14] = 0.000000;ui18.dPresetData[15] = 0.000000;
	ui18.cControlName = "LFO Pan Int";
	...
	ui19.m_pUserCookedUINTData = &m_uLFO1Waveform;
	ui19.cControlUnits = "                                                                ";
	ui19.cVariableName = "m_uLFO1Waveform";
	...
	ui20.fInitUserDoubleValue = 1.000000;
	ui20.fInitUserUINTValue = 0;
	ui20.m_pUserCookedIntData = NULL;
	ui20.m_pUserCookedFloatData = NULL;
	ui20.m_pUserCookedDoubleData = &m_dEG1DCAIntensity;
	ui20.m_pUserCookedUINTData = NULL;
	ui20.cControlUnits = "                                                                ";
	ui20.cVariableName = "m_dEG1DCAIntensity";
	ui20.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui20.dPresetData[0] = 1.000000;ui20.dPresetData[1] = 1.000000;ui20.dPresetData[2] = 1.000000;ui20.dPresetData[3] = 0.000000;ui20.dPresetData[4] = 0.000000;ui20.dPresetData[5] = 0.000000;ui20.dPresetData[6] = 0.000000;ui20.dPresetData[7] = 0.000000;ui20.dPresetData[8] = 0.000000;ui20.dPresetData[9] = 0.000000;ui20.dPresetData[10] = 0.000000;ui20.dPresetData[11] = 0.000000;ui20.dPresetData[12] = 0.000000;ui20.dPresetData[13] = 0.000000;ui20.dPresetData[14] = 0.000000;ui20.dPresetData[15] = 0.000000;
	ui20.cControlName = "DCA EG Int";
	...
	ui21.fUserDisplayDataHiLimit = 24.000000;
	...
	ui21.m_pUserCookedDoubleData = &m_dVolume_dB;
	ui21.m_pUserCookedUINTData = NULL;
	ui21.cControlUnits = "dB                                                              ";
	ui21.cVariableName = "m_dVolume_dB";
	ui21.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui21.dPresetData[0] = 0.000000;ui21.dPresetData[1] = 20.789295;ui21.dPresetData[2] = 20.789295;ui21.dPresetData[3] = 0.000000;ui21.dPresetData[4] = 0.000000;ui21.dPresetData[5] = 0.000000;ui21.dPresetData[6] = 0.000000;ui21.dPresetData[7] = 0.000000;ui21.dPresetData[8] = 0.000000;ui21.dPresetData[9] = 0.000000;ui21.dPresetData[10] = 0.000000;ui21.dPresetData[11] = 0.000000;ui21.dPresetData[12] = 0.000000;ui21.dPresetData[13] = 0.000000;ui21.dPresetData[14] = 0.000000;ui21.dPresetData[15] = 0.000000;
	ui21.cControlName = "Volume";
	...
	ui23.fUserDisplayDataLoLimit = 1.000000;
	ui23.fUserDisplayDataHiLimit = 12.000000;
	ui23.uUserDataType = intData;
	ui23.fInitUserIntValue = 1.000000;
	ui23.fInitUserFloatValue = 0;
	ui23.fInitUserDoubleValue = 0;
	ui23.fInitUserUINTValue = 0;
	ui23.m_pUserCookedIntData = &m_nPitchBendRange;
	ui23.m_pUserCookedFloatData = NULL;
	ui23.m_pUserCookedDoubleData = NULL;
	ui23.m_pUserCookedUINTData = NULL;
	ui23.cControlUnits = "semitones                                                       ";
	ui23.cVariableName = "m_nPitchBendRange";
	ui23.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui23.dPresetData[0] = 1.000000;ui23.dPresetData[1] = 1.000000;ui23.dPresetData[2] = 1.000000;ui23.dPresetData[3] = 0.000000;ui23.dPresetData[4] = 0.000000;ui23.dPresetData[5] = 0.000000;ui23.dPresetData[6] = 0.000000;ui23.dPresetData[7] = 0.000000;ui23.dPresetData[8] = 0.000000;ui23.dPresetData[9] = 0.000000;ui23.dPresetData[10] = 0.000000;ui23.dPresetData[11] = 0.000000;ui23.dPresetData[12] = 0.000000;ui23.dPresetData[13] = 0.000000;ui23.dPresetData[14] = 0.000000;ui23.dPresetData[15] = 0.000000;
	ui23.cControlName = "PBend Range";
	...
	ui24.m_pUserCookedUINTData = &m_uResetToZero;
	ui24.cControlUnits = "                                                                ";
	ui24.cVariableName = "m_uResetToZero";
	ui24.cEnumeratedList = "OFF,ON";
	...
	ui24.cControlName = "Reset to Zero";
	...
	ui25.m_pUserCookedUINTData = &m_uFilterKeyTrack;
	ui25.cControlUnits = "                                                                ";
	ui25.cVariableName = "m_uFilterKeyTrack";
	...
	ui25.cControlName = "Filter KeyTrack";
	...
	ui26.fUserDisplayDataLoLimit = 0.500000;
	ui26.fUserDisplayDataHiLimit = 10.000000;
	ui26.uUserDataType = doubleData;
	ui26.fInitUserIntValue = 0;
	ui26.fInitUserFloatValue = 0;
	ui26.fInitUserDoubleValue = 1.000000;
	ui26.fInitUserUINTValue = 0;
	ui26.m_pUserCookedIntData = NULL;
	ui26.m_pUserCookedFloatData = NULL;
	ui26.m_pUserCookedDoubleData = &m_dFilterKeyTrackIntensity;
	ui26.m_pUserCookedUINTData = NULL;
	ui26.cControlUnits = "                                                                ";
	ui26.cVariableName = "m_dFilterKeyTrackIntensity";
	ui26.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui26.dPresetData[0] = 1.000000;ui26.dPresetData[1] = 1.000000;ui26.dPresetData[2] = 1.000000;ui26.dPresetData[3] = 0.000000;ui26.dPresetData[4] = 0.000000;ui26.dPresetData[5] = 0.000000;ui26.dPresetData[6] = 0.000000;ui26.dPresetData[7] = 0.000000;ui26.dPresetData[8] = 0.000000;ui26.dPresetData[9] = 0.000000;ui26.dPresetData[10] = 0.000000;ui26.dPresetData[11] = 0.000000;ui26.dPresetData[12] = 0.000000;ui26.dPresetData[13] = 0.000000;ui26.dPresetData[14] = 0.000000;ui26.dPresetData[15] = 0.000000;
	ui26.cControlName = "KeyTrack Int";
	...
	ui27.m_pUserCookedUINTData = &m_uVelocityToAttackScaling;
	ui27.cControlUnits = "                                                                ";
	ui27.cVariableName = "m_uVelocityToAttackScaling";
	ui27.cEnumeratedList = "OFF,ON";
	...
	ui27.cControlName = "Vel->Att Scale";
	...
	ui28.uUserDataType = UINTData;
	ui28.fInitUserIntValue = 0;
	ui28.fInitUserFloatValue = 0;
	ui28.fInitUserDoubleValue = 0;
	ui28.fInitUserUINTValue = 0.000000;
	ui28.m_pUserCookedIntData = NULL;
	ui28.m_pUserCookedFloatData = NULL;
	ui28.m_pUserCookedDoubleData = NULL;
	ui28.m_pUserCookedUINTData = &m_uNoteNumberToDecayScaling;
	ui28.cControlUnits = "                                                                ";
	ui28.cVariableName = "m_uNoteNumberToDecayScaling";
	ui28.cEnumeratedList = "OFF,ON";
	ui28.dPresetData[0] = 0.000000;ui28.dPresetData[1] = 0.000000;ui28.dPresetData[2] = 0.000000;ui28.dPresetData[3] = 0.000000;ui28.dPresetData[4] = 0.000000;ui28.dPresetData[5] = 0.000000;ui28.dPresetData[6] = 0.000000;ui28.dPresetData[7] = 0.000000;ui28.dPresetData[8] = 0.000000;ui28.dPresetData[9] = 0.000000;ui28.dPresetData[10] = 0.000000;ui28.dPresetData[11] = 0.000000;ui28.dPresetData[12] = 0.000000;ui28.dPresetData[13] = 0.000000;ui28.dPresetData[14] = 0.000000;ui28.dPresetData[15] = 0.000000;
	ui28.cControlName = "Note->Dcy Scale";
	...
	m_uLoopMode = 0;
	CUICtrl ui29;
	ui29.uControlType = FILTER_CONTROL_RADIO_SWITCH_VARIABLE;
	ui29.uControlId = 41;
	ui29.bLogSlider = false;
	ui29.bExpSlider = false;
	ui29.fUserDisplayDataLoLimit = 0.000000;
	ui29.fUserDisplayDataHiLimit = 2.000000;
	...
	ui29.m_pUserCookedUINTData = &m_uLoopMode;
	ui29.cControlUnits = "";
	ui29.cVariableName = "m_uLoopMode";
	ui29.cEnumeratedList = "sustain,loop,oneShot";
	...
	m_PresetNames[1] = "Analoggy";
	pJSProg = new float[MAX_JS_PROGRAM_STEPS*MAX_JS_PROGRAM_STEP_VARS];
	pJSProg[JS_PROG_INDEX(0,0)] = 0.000000;pJSProg[JS_PROG_INDEX(0,1)] = 0.000000;pJSProg[JS_PROG_INDEX(0,2)] = 0.000000;pJSProg[JS_PROG_INDEX(0,3)] = 0.000000;pJSProg[JS_PROG_INDEX(0,4)] = 0.000000;pJSProg[JS_PROG_INDEX(0,5)] = 0.000000;pJSProg[JS_PROG_INDEX(0,6)] = 0.000000;pJSProg[JS_PROG_INDEX(1,0)] = 0.000000;pJSProg[JS_PROG_INDEX(1,1)] = 0.000000;pJSProg[JS_PROG_INDEX(1,2)] = 0.000000;pJSProg[JS_PROG_INDEX(1,3)] = 0.000000;pJSProg[JS_PROG_INDEX(1,4)] = 0.000000;pJSProg[JS_PROG_INDEX(1,5)] = 0.000000;pJSProg[JS_PROG_INDEX(1,6)] = 0.000000;pJSProg[JS_PROG_INDEX(2,0)] = 0.000000;pJSProg[JS_PROG_INDEX(2,1)] = 0.000000;pJSProg[JS_PROG_INDEX(2,2)] = 0.000000;pJSProg[JS_PROG_INDEX(2,3)] = 0.000000;pJSProg[JS_PROG_INDEX(2,4)] = 0.000000;pJSProg[JS_PROG_INDEX(2,5)] = 0.000000;pJSProg[JS_PROG_INDEX(2,6)] = 0.000000;pJSProg[JS_PROG_INDEX(3,0)] = 0.000000;pJSProg[JS_PROG_INDEX(3,1)] = 0.000000;pJSProg[JS_PROG_INDEX(3,2)] = 0.000000;pJSProg[JS_PROG_INDEX(3,3)] = 0.000000;pJSProg[JS_PROG_INDEX(3,4)] = 0.000000;pJSProg[JS_PROG_INDEX(3,5)] = 0.000000;pJSProg[JS_PROG_INDEX(3,6)] = 0.000000;pJSProg[JS_PROG_INDEX(4,0)] = 0.000000;pJSProg[JS_PROG_INDEX(4,1)] = 0.000000;pJSProg[JS_PROG_INDEX(4,2)] = 0.000000;pJSProg[JS_PROG_INDEX(4,3)] = 0.000000;pJSProg[JS_PROG_INDEX(4,4)] = 0.000000;pJSProg[JS_PROG_INDEX(4,5)] = 0.000000;pJSProg[JS_PROG_INDEX(4,6)] = 0.000000;pJSProg[JS_PROG_INDEX(5,0)] = 0.000000;pJSProg[JS_PROG_INDEX(5,1)] = 0.000000;pJSProg[JS_PROG_INDEX(5,2)] = 0.000000;pJSProg[JS_PROG_INDEX(5,3)] = 0.000000;pJSProg[JS_PROG_INDEX(5,4)] = 0.000000;pJSProg[JS_PROG_INDEX(5,5)] = 0.000000;pJSProg[JS_PROG_INDEX(5,6)] = 0.000000;pJSProg[JS_PROG_INDEX(6,0)] = 0.000000;pJSProg[JS_PROG_INDEX(6,1)] = 0.000000;pJSProg[JS_PROG_INDEX(6,2)] = 0.000000;pJSProg[JS_PROG_INDEX(6,3)] = 0.000000;pJSProg[JS_PROG_INDEX(6,4)] = 0.000000;pJSProg[JS_PROG_INDEX(6,5)] = 0.000000;pJSProg[JS_PROG_INDEX(6,6)] = 0.000000;pJSProg[JS_PROG_INDEX(7,0)] = 0.000000;pJSProg[JS_PROG_INDEX(7,1)] = 0.000000;pJSProg[JS_PROG_INDEX(7,2)] = 0.000000;pJSProg[JS_PROG_INDEX(7,3)] = 0.000000;pJSProg[JS_PROG_INDEX(7,4)] = 0.000000;pJSProg[JS_PROG_INDEX(7,5)] = 0.000000;pJSProg[JS_PROG_INDEX(7,6)] = 0.000000;pJSProg[JS_PROG_INDEX(8,0)] = 0.000000;pJSProg[JS_PROG_INDEX(8,1)] = 0.000000;pJSProg[JS_PROG_INDEX(8,2)] = 0.000000;pJSProg[JS_PROG_INDEX(8,3)] = 0.000000;pJSProg[JS_PROG_INDEX(8,4)] = 0.000000;pJSProg[JS_PROG_INDEX(8,5)] = 0.000000;pJSProg[JS_PROG_INDEX(8,6)] = 0.000000;pJSProg[JS_PROG_INDEX(9,0)] = 0.000000;pJSProg[JS_PROG_INDEX(9,1)] = 0.000000;pJSProg[JS_PROG_INDEX(9,2)] = 0.000000;pJSProg[JS_PROG_INDEX(9,3)] = 0.000000;pJSProg[JS_PROG_INDEX(9,4)] = 0.000000;pJSProg[JS_PROG_INDEX(9,5)] = 0.000000;pJSProg[JS_PROG_INDEX(9,6)] = 0.000000;pJSProg[JS_PROG_INDEX(10,0)] = 0.000000;pJSProg[JS_PROG_INDEX(10,1)] = 0.000000;pJSProg[JS_PROG_INDEX(10,2)] = 0.000000;pJSProg[JS_PROG_INDEX(10,3)] = 0.000000;pJSProg[JS_PROG_INDEX(10,4)] = 0.000000;pJSProg[JS_PROG_INDEX(10,5)] = 0.000000;pJSProg[JS_PROG_INDEX(10,6)] = 0.000000;pJSProg[JS_PROG_INDEX(11,0)] = 0.000000;pJSProg[JS_PROG_INDEX(11,1)] = 0.000000;pJSProg[JS_PROG_INDEX(11,2)] = 0.000000;pJSProg[JS_PROG_INDEX(11,3)] = 0.000000;pJSProg[JS_PROG_INDEX(11,4)] = 0.000000;pJSProg[JS_PROG_INDEX(11,5)] = 0.000000;pJSProg[JS_PROG_INDEX(11,6)] = 0.000000;pJSProg[JS_PROG_INDEX(12,0)] = 0.000000;pJSProg[JS_PROG_INDEX(12,1)] = 0.000000;pJSProg[JS_PROG_INDEX(12,2)] = 0.000000;pJSProg[JS_PROG_INDEX(12,3)] = 0.000000;pJSProg[JS_PROG_INDEX(12,4)] = 0.000000;pJSProg[JS_PROG_INDEX(12,5)] = 0.000000;pJSProg[JS_PROG_INDEX(12,6)] = 0.000000;pJSProg[JS_PROG_INDEX(13,0)] = 0.000000;pJSProg[JS_PROG_INDEX(13,1)] = 0.000000;pJSProg[JS_PROG_INDEX(13,2)] = 0.000000;pJSProg[JS_PROG_INDEX(13,3)] = 0.000000;pJSProg[JS_PROG_INDEX(13,4)] = 0.000000;pJSProg[JS_PROG_INDEX(13,5)] = 0.000000;pJSProg[JS_PROG_INDEX(13,6)] = 0.000000;pJSProg[JS_PROG_INDEX(14,0)] = 0.000000;pJSProg[JS_PROG_INDEX(14,1)] = 0.000000;pJSProg[JS_PROG_INDEX(14,2)] = 0.000000;pJSProg[JS_PROG_INDEX(14,3)] = 0.000000;pJSProg[JS_PROG_INDEX(14,4)] = 0.000000;pJSProg[JS_PROG_INDEX(14,5)] = 0.000000;pJSProg[JS_PROG_INDEX(14,6)] = 0.000000;pJSProg[JS_PROG_INDEX(15,0)] = 0.000000;pJSProg[JS_PROG_INDEX(15,1)] = 0.000000;pJSProg[JS_PROG_INDEX(15,2)] = 0.000000;pJSProg[JS_PROG_INDEX(15,3)] = 0.000000;pJSProg[JS_PROG_INDEX(15,4)] = 0.000000;pJSProg[JS_PROG_INDEX(15,5)] = 0.000000;pJSProg[JS_PROG_INDEX(15,6)] = 0.000000;
	m_PresetJSPrograms[1] = pJSProg;

	m_PresetNames[2] = "Vocal";
	pJSProg = new float[MAX_JS_PROGRAM_STEPS*MAX_JS_PROGRAM_STEP_VARS];
	pJSProg[JS_PROG_INDEX(0,0)] = 0.000000;pJSProg[JS_PROG_INDEX(0,1)] = 0.000000;pJSProg[JS_PROG_INDEX(0,2)] = 0.000000;pJSProg[JS_PROG_INDEX(0,3)] = 0.000000;pJSProg[JS_PROG_INDEX(0,4)] = 0.000000;pJSProg[JS_PROG_INDEX(0,5)] = 0.000000;pJSProg[JS_PROG_INDEX(0,6)] = 0.000000;pJSProg[JS_PROG_INDEX(1,0)] = 0.000000;pJSProg[JS_PROG_INDEX(1,1)] = 0.000000;pJSProg[JS_PROG_INDEX(1,2)] = 0.000000;pJSProg[JS_PROG_INDEX(1,3)] = 0.000000;pJSProg[JS_PROG_INDEX(1,4)] = 0.000000;pJSProg[JS_PROG_INDEX(1,5)] = 0.000000;pJSProg[JS_PROG_INDEX(1,6)] = 0.000000;pJSProg[JS_PROG_INDEX(2,0)] = 0.000000;pJSProg[JS_PROG_INDEX(2,1)] = 0.000000;pJSProg[JS_PROG_INDEX(2,2)] = 0.000000;pJSProg[JS_PROG_INDEX(2,3)] = 0.000000;pJSProg[JS_PROG_INDEX(2,4)] = 0.000000;pJSProg[JS_PROG_INDEX(2,5)] = 0.000000;pJSProg[JS_PROG_INDEX(2,6)] = 0.000000;pJSProg[JS_PROG_INDEX(3,0)] = 0.000000;pJSProg[JS_PROG_INDEX(3,1)] = 0.000000;pJSProg[JS_PROG_INDEX(3,2)] = 0.000000;pJSProg[JS_PROG_INDEX(3,3)] = 0.000000;pJSProg[JS_PROG_INDEX(3,4)] = 0.000000;pJSProg[JS_PROG_INDEX(3,5)] = 0.000000;pJSProg[JS_PROG_INDEX(3,6)] = 0.000000;pJSProg[JS_PROG_INDEX(4,0)] = 0.000000;pJSProg[JS_PROG_INDEX(4,1)] = 0.000000;pJSProg[JS_PROG_INDEX(4,2)] = 0.000000;pJSProg[JS_PROG_INDEX(4,3)] = 0.000000;pJSProg[JS_PROG_INDEX(4,4)] = 0.000000;pJSProg[JS_PROG_INDEX(4,5)] = 0.000000;pJSProg[JS_PROG_INDEX(4,6)] = 0.000000;pJSProg[JS_PROG_INDEX(5,0)] = 0.000000;pJSProg[JS_PROG_INDEX(5,1)] = 0.000000;pJSProg[JS_PROG_INDEX(5,2)] = 0.000000;pJSProg[JS_PROG_INDEX(5,3)] = 0.000000;pJSProg[JS_PROG_INDEX(5,4)] = 0.000000;pJSProg[JS_PROG_INDEX(5,5)] = 0.000000;pJSProg[JS_PROG_INDEX(5,6)] = 0.000000;pJSProg[JS_PROG_INDEX(6,0)] = 0.000000;pJSProg[JS_PROG_INDEX(6,1)] = 0.000000;pJSProg[JS_PROG_INDEX(6,2)] = 0.000000;pJSProg[JS_PROG_INDEX(6,3)] = 0.000000;pJSProg[JS_PROG_INDEX(6,4)] = 0.000000;pJSProg[JS_PROG_INDEX(6,5)] = 0.000000;pJSProg[JS_PROG_INDEX(6,6)] = 0.000000;pJSProg[JS_PROG_INDEX(7,0)] = 0.000000;pJSProg[JS_PROG_INDEX(7,1)] = 0.000000;pJSProg[JS_PROG_INDEX(7,2)] = 0.000000;pJSProg[JS_PROG_INDEX(7,3)] = 0.000000;pJSProg[JS_PROG_INDEX(7,4)] = 0.000000;pJSProg[JS_PROG_INDEX(7,5)] = 0.000000;pJSProg[JS_PROG_INDEX(7,6)] = 0.000000;pJSProg[JS_PROG_INDEX(8,0)] = 0.000000;pJSProg[JS_PROG_INDEX(8,1)] = 0.000000;pJSProg[JS_PROG_INDEX(8,2)] = 0.000000;pJSProg[JS_PROG_INDEX(8,3)] = 0.000000;pJSProg[JS_PROG_INDEX(8,4)] = 0.000000;pJSProg[JS_PROG_INDEX(8,5)] = 0.000000;pJSProg[JS_PROG_INDEX(8,6)] = 0.000000;pJSProg[JS_PROG_INDEX(9,0)] = 0.000000;pJSProg[JS_PROG_INDEX(9,1)] = 0.000000;pJSProg[JS_PROG_INDEX(9,2)] = 0.000000;pJSProg[JS_PROG_INDEX(9,3)] = 0.000000;pJSProg[JS_PROG_INDEX(9,4)] = 0.000000;pJSProg[JS_PROG_INDEX(9,5)] = 0.000000;pJSProg[JS_PROG_INDEX(9,6)] = 0.000000;pJSProg[JS_PROG_INDEX(10,0)] = 0.000000;pJSProg[JS_PROG_INDEX(10,1)] = 0.000000;pJSProg[JS_PROG_INDEX(10,2)] = 0.000000;pJSProg[JS_PROG_INDEX(10,3)] = 0.000000;pJSProg[JS_PROG_INDEX(10,4)] = 0.000000;pJSProg[JS_PROG_INDEX(10,5)] = 0.000000;pJSProg[JS_PROG_INDEX(10,6)] = 0.000000;pJSProg[JS_PROG_INDEX(11,0)] = 0.000000;pJSProg[JS_PROG_INDEX(11,1)] = 0.000000;pJSProg[JS_PROG_INDEX(11,2)] = 0.000000;pJSProg[JS_PROG_INDEX(11,3)] = 0.000000;pJSProg[JS_PROG_INDEX(11,4)] = 0.000000;pJSProg[JS_PROG_INDEX(11,5)] = 0.000000;pJSProg[JS_PROG_INDEX(11,6)] = 0.000000;pJSProg[JS_PROG_INDEX(12,0)] = 0.000000;pJSProg[JS_PROG_INDEX(12,1)] = 0.000000;pJSProg[JS_PROG_INDEX(12,2)] = 0.000000;pJSProg[JS_PROG_INDEX(12,3)] = 0.000000;pJSProg[JS_PROG_INDEX(12,4)] = 0.000000;pJSProg[JS_PROG_INDEX(12,5)] = 0.000000;pJSProg[JS_PROG_INDEX(12,6)] = 0.000000;pJSProg[JS_PROG_INDEX(13,0)] = 0.000000;pJSProg[JS_PROG_INDEX(13,1)] = 0.000000;pJSProg[JS_PROG_INDEX(13,2)] = 0.000000;pJSProg[JS_PROG_INDEX(13,3)] = 0.000000;pJSProg[JS_PROG_INDEX(13,4)] = 0.000000;pJSProg[JS_PROG_INDEX(13,5)] = 0.000000;pJSProg[JS_PROG_INDEX(13,6)] = 0.000000;pJSProg[JS_PROG_INDEX(14,0)] = 0.000000;pJSProg[JS_PROG_INDEX(14,1)] = 0.000000;pJSProg[JS_PROG_INDEX(14,2)] = 0.000000;pJSProg[JS_PROG_INDEX(14,3)] = 0.000000;pJSProg[JS_PROG_INDEX(14,4)] = 0.000000;pJSProg[JS_PROG_INDEX(14,5)] = 0.000000;pJSProg[JS_PROG_INDEX(14,6)] = 0.000000;pJSProg[JS_PROG_INDEX(15,0)] = 0.000000;pJSProg[JS_PROG_INDEX(15,1)] = 0.000000;pJSProg[JS_PROG_INDEX(15,2)] = 0.000000;pJSProg[JS_PROG_INDEX(15,3)] = 0.000000;pJSProg[JS_PROG_INDEX(15,4)] = 0.000000;pJSProg[JS_PROG_INDEX(15,5)] = 0.000000;pJSProg[JS_PROG_INDEX(15,6)] = 0.000000;
