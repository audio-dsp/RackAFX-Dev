...
*/
bool __stdcall CSoulForce::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CSoulForce::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CSoulForce::prepareForPlay()
{
	// Add your code here:
...
*/
bool __stdcall CSoulForce::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
//
bool __stdcall CSoulForce::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CSoulForce::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CSoulForce::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CSoulForce::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CSoulForce::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CSoulForce::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CSoulForce::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CSoulForce::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CSoulForce::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CSoulForce::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CSoulForce::midiClock()
{
...
bool __stdcall CSoulForce::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CSoulForce::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CSoulForce::showGUI(void* pInfo)
{
...
bool __stdcall CSoulForce::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
