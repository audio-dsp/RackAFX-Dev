//	SpectralExaggerator.h - Re-written version of PVOC's spectralexaggerator.
//	--------------------------------------------------------------------------
...
#ifndef SPECTRALEXAGGERATOR_H_
#define SPECTRALEXAGGERATOR_H_

#include "PhaseVocoder.h"
#include "BaseClasses.h"

///	Re-written version of PVOC's spectralexaggerator.
class SpectralExaggerator : public SpectralExaggeratorBase
{
  public:
	///	Constructor.
	SpectralExaggerator();
