...
void CNanoSynth::update()
{
	...
	// this is no longer needed, done on base class, replaced by line above
...
// **--0xDEA7--**
	...
	ui18.fUserDisplayDataHiLimit = 2.000000;
	...
	ui18.cControlName = "Filter Keytrack Int";
