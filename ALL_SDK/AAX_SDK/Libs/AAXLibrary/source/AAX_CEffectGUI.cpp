...
AAX_CEffectGUI::~AAX_CEffectGUI()
{	
	Uninitialize();	//<DMT>  Just to guarantee that all these things get broken down...
}
...
AAX_Result AAX_CEffectGUI::SetViewContainer ( IACFUnknown * inViewContainer )
{
	...
	{
		mViewContainer = new AAX_VViewContainer ( inViewContainer );
...
AAX_EViewContainer_Type AAX_CEffectGUI::GetViewContainerType ()
{
	...
	if ( mViewContainer )
		result = (AAX_EViewContainer_Type) mViewContainer->GetType ();
