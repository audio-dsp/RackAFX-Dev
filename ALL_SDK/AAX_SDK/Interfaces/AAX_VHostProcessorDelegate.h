...
public:
	...
	virtual AAX_Result	GetAudio ( const float * const inAudioIns [], int32_t inAudioInCount, int64_t inLocation, int32_t * ioNumSamples ) AAX_OVERRIDE; ///< \copydoc AAX_IHostProcessorDelegate::GetAudio()
	virtual int32_t		GetSideChainInputNum () AAX_OVERRIDE; ///< \copydoc AAX_IHostProcessorDelegate::GetSideChainInputNum()
	virtual AAX_Result	ForceAnalyze () AAX_OVERRIDE; ///< \copydoc AAX_IHostProcessorDelegate::ForceAnalyze()
	virtual AAX_Result	ForceProcess () AAX_OVERRIDE; ///< \copydoc AAX_IHostProcessorDelegate::ForceProcess()
