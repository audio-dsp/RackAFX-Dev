...
public:
	...
	virtual AAX_Result		RegisterParameter ( AAX_CParamID iParameterID ) AAX_OVERRIDE;
	virtual AAX_Result		UnregisterParameter ( AAX_CParamID iParameterID ) AAX_OVERRIDE;
	virtual AAX_Result		PostSetValueRequest ( AAX_CParamID iParameterID, double iNormalizedValue ) const AAX_OVERRIDE;
	virtual AAX_Result		PostCurrentValue ( AAX_CParamID iParameterID, double iNormalizedValue ) const AAX_OVERRIDE;
	virtual AAX_Result		PostTouchRequest ( AAX_CParamID iParameterID ) AAX_OVERRIDE;
	virtual AAX_Result		PostReleaseRequest ( AAX_CParamID iParameterID ) AAX_OVERRIDE;
	virtual AAX_Result		GetTouchState ( AAX_CParamID iParameterID, AAX_CBoolean * outTouched ) AAX_OVERRIDE;
