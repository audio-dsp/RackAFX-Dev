...
public: // AAX_IFeatureInfo
	virtual AAX_Result SupportLevel(AAX_ESupportLevel& oSupportLevel) const AAX_OVERRIDE; ///< \copydoc AAX_IFeatureInfo::SupportLevel()
	virtual const AAX_IPropertyMap* AcquireProperties() const AAX_OVERRIDE; ///< \copydoc AAX_IFeatureInfo::AcquireProperties()
	virtual const AAX_Feature_UID& ID() const AAX_OVERRIDE; ///< \copydoc AAX_IFeatureInfo::ID()
