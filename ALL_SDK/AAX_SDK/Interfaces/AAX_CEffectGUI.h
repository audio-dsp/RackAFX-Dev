...
public: ///////////////////////////////////////////////////////////////////////////// AAX_IEffectGUI
	...
	virtual AAX_Result GetViewSize (AAX_Point * /* oViewSize */ ) const AAX_OVERRIDE
	{
		return AAX_SUCCESS;
	}
	//@}end View accessors
	 ...
	 */
	//@{
	virtual AAX_Result Draw (AAX_Rect * /* iDrawRect */ ) AAX_OVERRIDE
	{
		return AAX_SUCCESS;
	}
	...
	virtual AAX_Result SetControlHighlightInfo (AAX_CParamID /* iParameterID */, AAX_CBoolean /* iIsHighlighted */, AAX_EHighlightColor /* iColor */) AAX_OVERRIDE
	{
		return AAX_SUCCESS;
	}
