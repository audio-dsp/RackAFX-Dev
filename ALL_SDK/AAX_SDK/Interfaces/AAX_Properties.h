...
enum AAX_EProperty
{
	...
	/** \brief Four-character osid-style Collection identifier
	 *	
	 *	Must be identical for all ProcessProcs within a single
	...
	/** \brief Four-character osid-style Effect identifier for real-time native audio Effects
	 *	
	 *	All registered plug-in IDs (\ref AAX_eProperty_PlugInID_Native,
	 *	\ref AAX_eProperty_PlugInID_AudioSuite, and \ref AAX_eProperty_PlugInID_TI) must be
	...
	/** \brief Four-character osid-style Effect identifier for offline native audio Effects
	 *
	 *	All registered plug-in IDs (\ref AAX_eProperty_PlugInID_Native,
	 *	\ref AAX_eProperty_PlugInID_AudioSuite, and \ref AAX_eProperty_PlugInID_TI) must be
	 *	unique across all ProcessProcs registered within a single
	...
	/** \brief Four-character osid-style Effect identifier for real-time TI-accelerated audio
	 *	Effects
	 *
	 *	All registered product IDs (\ref AAX_eProperty_PlugInID_Native,
	 *	\ref AAX_eProperty_PlugInID_AudioSuite, and \ref AAX_eProperty_PlugInID_TI) must be
	 *	unique across all ProcessProcs registered within a single
	 *	\ref AAX_IEffectDescriptor "Effect".
     *
	...
	/** \brief Four-character osid-style Effect identifier for a corresponding deprecated Effect
	 *
	...
	/** \brief Four-character osid-style Effect identifier for audio effects rendered on
	 *	external hardware.
	 *
	 *	\note This property is not currently used by any %AAX plug-in host software
	 *
	 *	All registered plug-in IDs must be unique across all ProcessProcs registered within a
     ...
     *
     *  \todo This property should always be enabled for %AAX plug-ins
     */
	...
	/** \brief The Effect controls its own progress dialog.  If unsupported, the host manages this
	 *	dialog.
     *
     *  \li Apply this property at the \ref AAX_IEffectDescriptor level
     *  \li This property is only applicable to offline processing
     *
     *  \legacy Was pluginGestalt_SupportsProgressDialog
     */
    AAX_eProperty_SupportsProgressDialog = 111,
