...
public: ///////////////////////////////////////// constructor/destructor
	...
	virtual ~DemoGain_SliderJuce();
	
protected: ////////////////////////////////////// juce::Slider
	void mouseDown (const juce::MouseEvent& e); // HACK: Non-virtual in juce::Slider
    void mouseUp (const juce::MouseEvent& e);   // HACK: Non-virtual in juce::Slider
    void mouseDrag (const juce::MouseEvent& e); // HACK: Non-virtual in juce::Slider
